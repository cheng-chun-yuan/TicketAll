...
var FocusLock = React13.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  var _React$useState2 = React13.useState({}), id4 = _React$useState2[0];
  var onActivation = React13.useCallback(function() {
  ...
  ], !disabled && React13.createElement(SideCar, {
    id: id4,
...
function MoveFocusInside(_ref2) {
  ...
  return React18.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled2), {
    ref,
    className
  }), children);
}
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const styles = (0, import_react118.useMemo)(() => {
  ...
  const childrenToRender = (0, import_react118.useMemo)(
    () => shouldWrapChildren ? import_react118.Children.map(children, (child, index2) => (0, import_jsx_runtime70.jsx)(WrapItem, { children: child }, index2)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react119.useMemo)(
    () => getDividerStyles({ spacing, direction }),
    [spacing, direction]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react119.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index2) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react119.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime72.jsxs)(import_react119.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react120.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime79.jsx)(import_jsx_runtime79.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime79.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime79.jsx)(import_react120.Fragment, { children: chunk.text }, index2);
  }) });
}
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id4 = `${menuId}-menuitem-${(0, import_react131.useId)()}`;
...
function useNumberInput(props = {}) {
  ...
  const format2 = (0, import_react144.useCallback)(
    (value) => {
      var _a2;
...
var SelectIcon = (props) => {
  ...
  return (0, import_jsx_runtime134.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react154.isValidElement)(children) ? clone : null });
};
