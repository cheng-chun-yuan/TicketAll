...
var WalletConnect = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-ARSPA6UK.js");
...
var SafeWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-GJN7I4NH.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect-v1.browser.esm-GQFLK25X.js");
...
//# sourceMappingURL=chunk-JKC4PSUA.js.map
